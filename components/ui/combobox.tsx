  ...
  return (
    <ComboboxPrimitive.Portal>
      ...
      >
        <span
          className={cn(
            "relative flex max-h-full min-w-(--anchor-width) max-w-(--available-width) origin-(--transform-origin) overflow-hidden rounded-[var(--ui-radius-control)] border border-[color-mix(in_srgb,var(--ui-border)_92%,transparent)] bg-[var(--ui-surface)] not-dark:bg-clip-padding shadow-lg/5 transition-[scale,opacity] before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--ui-radius-control)-1px)] before:shadow-[0_1px_--theme(--color-black/4%)] dark:before:shadow-[0_-1px_--theme(--color-white/6%)]",
            className,
          )}
        >
